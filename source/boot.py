...
def updateTask(user_id): #i honestly dont know what to do here yet
	if request.method == 'POST':
		return {'update': 'user'}
	else:
		return {'Show' : 'Form'}

@api.route('/user/delete/<int:user_id>', methods=['PUT', 'DELETE']) #I dont know if I want to do DELETE or PUT
